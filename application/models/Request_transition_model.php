...
class Request_transition_model extends CI_model{

	public $table = 'request_transition';
	...
	public function get_by_request($request_id)
	{
		...
		$query=$this->db->get();
		log_message('DEBUG', 'Request_transition_model>get_by_request(): ' . $this->db->last_query());
		return $query->result();
	}
	...
	public function get_all()
	{
		$this->db->from($this->table);
		$query=$this->db->get();
		log_message('DEBUG', 'Request_transition_model>get_all(): ' . $this->db->last_query());
		return $query->result();
	}
	...
	public function get_by_id($id)
	{
		...
		$this->db->where('id',$id);
		$query = $this->db->get();
 		log_message('DEBUG', 'Request_transition_model>get_by_id(): ' . $this->db->last_query());
		return $query->row();
	}
	...
	public function create($data)
	{
		...
		log_message('DEBUG', 'Request_transition_model>add(): ' . $this->db->last_query());
		return $result;
	}
	...
	public function delete_by_id($id)
	{
		...
		log_message('DEBUG', 'Request_transition_model>delete_by_id(): ' . $this->db->last_query());
	}
